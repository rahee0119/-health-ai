...
# =========================================================================
glucose_list = [125, 95, 130, 140, 85, 110, 90, 150, 105, 115]
bp_list = [135, 115, 145, 150, 110, 125, 120, 155, 118, 90]  # 90은 기립성 저혈압 패턴
bmi_list = [28.5, 22.0, 24.5, 31.2, 21.5, 26.0, 18.0, 29.0, 23.5, 20.1]
hemo_list = [14.5, 15.0, 13.8, 14.2, 15.2, 14.0, 9.5, 13.5, 10.2, 13.0]
age_list = [45, 23, 55, 62, 28, 38, 19, 67, 34, 16]
outcome_list = [1, 0, 3, 4, 0, 2, 6, 5, 7, 8] # 0:정상, 1:당뇨, 2:식도염, 3:고혈압, 4:비만, 5:심장병, 6:빈혈, 7:뇌졸중, 8:기립성저혈압
...
if st.button("🚀 인공지능 종합 건강 처방 리포트 생성"):
    ...
    if predicted_class in:  # 당뇨, 비만 우려군
    ...
    elif predicted_class in:  # 고혈압, 심장병, 뇌졸중 우려군
