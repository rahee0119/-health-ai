...
# =========================================================================
glucose_list = [125, 90, 140, 110, 130, 95, 85, 135, 105, 92]
bp_list = [135, 115, 145, 120, 150, 110, 118, 140, 122, 90]  # 90은 기립성 저혈압 패턴
bmi_list = [28.5, 22.0, 24.5, 31.2, 21.5, 26.0, 18.0, 29.0, 23.5, 20.1]
hemo_list = [14.5, 15.0, 13.8, 14.2, 15.2, 14.0, 9.5, 13.5, 10.2, 13.0]
age_list = [45, 23, 55, 34, 62, 29, 21, 58, 38, 17]
outcome_list = [1, 0, 3, 2, 7, 4, 6, 5, 0, 8] # 0:정상, 1:당뇨, 2:식도염, 3:고혈압, 4:비만, 5:심장병, 6:빈혈, 7:뇌졸중, 8:기립성저혈압
...
# =========================================================================
# [프론트엔드] 웹 사용자 인터페이스 (GUI) 구축 - input() 완전 제거
# =========================================================================
...
if st.button("🚀 인공지능 종합 건강 처방 리포트 생성"):
    ...
    predicted_class = knn_model.predict(user_profile)
